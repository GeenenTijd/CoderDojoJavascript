(function functions() {
	...
	function functionsController($location, $routeParams, progress, questions) {
		...
		function goNext() {
			$location.path('/functions/' + (vm.question + 1));
		}
	}

	angular
		.module('coderDojoApp')
		.controller('functionsController', ['$location', '$routeParams', 'progressFactory', 'functionsQuestions', functionsController]);
})();